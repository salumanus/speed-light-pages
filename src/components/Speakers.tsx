...
const salumanusSpeakers: Speaker[] = [
  ...
  { name: "Andrzej Wojnar", role: "Dyrektor ds. Technicznych", desc: "Inżynier i manager z artystyczną duszą. W Salumanus zagląda w bity i fotony - a czasem dzieli je na czworo. Po godzinach: fotografia i enologia.", linkedin: "https://www.linkedin.com/in/andrzej-wojnar-kr", image: andrzejWojnarImg },
    ...
    <section className="bg-background my-[39px]" style={{ paddingTop: "1rem", paddingBottom: "1rem" }}>
      <div className="container-conf bg-[#f8f4f2] my-0 py-[40px]">
        <AnimatedSection>
          ...
          <h2 className="font-heading text-4xl md:text-5xl text-foreground leading-tight lg:text-4xl" style={{ marginBottom: "1.5rem" }}>
