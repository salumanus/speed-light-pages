    ...
    <section className="bg-background my-[39px]" style={{ paddingTop: "1rem", paddingBottom: "1rem" }}>
      <div className="container-conf">
        <AnimatedSection>
          ...
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl text-foreground leading-tight" style={{ marginBottom: "1.5rem" }}>
    ...
    <section className="bg-[#f8f4f2]" style={{ paddingTop: "3.5rem", paddingBottom: "3.5rem" }}>
      <div className="container-conf">
        <AnimatedSection>
          ...
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl leading-tight" style={{ color: "#000", marginBottom: "1.5rem" }}>
