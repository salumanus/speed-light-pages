...
const Hero = () => {
  ...
  const items = [
    ...
    { el: <p className="text-base sm:text-lg md:text-xl xl:text-2xl text-primary-foreground font-normal">Konferencja dla specjalistów z branży Telko i Data Center. Technologia na najwyższych obrotach.</p>, delay: 0.3 },
