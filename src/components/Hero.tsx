...
const Hero = () => {
  ...
  const items = [
    ...
    { el: <h1 className="font-heading text-6xl sm:text-7xl md:text-8xl text-dark-fg leading-none lg:text-8xl font-medium">Inżynieria zwycięstwa</h1>, delay: 0.15 },
  ...
  return (
    <section id="home" ref={ref} className="relative h-[63vh] min-h-[450px] flex items-end overflow-hidden">
