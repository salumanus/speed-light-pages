...
const Hero = () => {
  ...
  const items = [
    ...
    { el: <h1 className="font-heading text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-dark-fg leading-none">Inżynieria zwycięstwa</h1>, delay: 0.15 },
  ...
  return (
    <section id="home" ref={ref} className="relative h-screen min-h-[600px] flex items-end overflow-hidden">
