  ...
  <section className="section-py bg-background">
    <div className="container-conf">
      <AnimatedSection>
        ...
        <h2 className="font-heading text-4xl md:text-5xl text-foreground mb-16 w-full leading-tight lg:text-4xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {cards.map((card, i) => (
          <AnimatedSection key={card.title} delay={i * 0.1}>
            <motion.div
              whileHover={{ y: -4 }}
              className="bg-accent text-accent-foreground p-8 md:p-10 h-full py-[15px] px-[15px] items-start justify-start flex flex-col rounded-sm"
